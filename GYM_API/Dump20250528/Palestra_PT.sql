...
CREATE TABLE `PT` (
  ...
  PRIMARY KEY (`SSN_D`),
  CONSTRAINT `fk_PT_1` FOREIGN KEY (`SSN_D`) REFERENCES `DIPENDENTE` (`SSN_D`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `PT` VALUES ('111111111','Bodybuilding'),('333333333','CrossFit'),('555555555','Functional Training'),('777777777','Calisthenics'),('999999999','HIIT');
